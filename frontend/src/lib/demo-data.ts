...
export const insightCards: InsightCard[] = [
  { title: "Net Worth", value: "Rs 14.8L", delta: "+8.2% this quarter", tone: "positive" },
  { title: "AI Cashback Invested", value: "Rs 18,420", delta: "92 automations fired", tone: "positive" },
...
export const advisorMessages: ChatMessage[] = [
  { role: "user", content: "Can I afford a Rs 50k MacBook purchase this month?" },
  {
    role: "assistant",
    content:
...
export const transactionRows = [
  { merchant: "Swiggy", category: "Food", amount: "-Rs 1,240", status: "Leak risk" },
  { merchant: "Salary", category: "Income", amount: "+Rs 1,85,000", status: "Captured" },
  { merchant: "Zerodha SIP", category: "Investment", amount: "-Rs 12,000", status: "On plan" },
  { merchant: "Netflix", category: "Subscription", amount: "-Rs 649", status: "Review" },
];
