...
import { WealthSweepControl } from "@/components/finance/wealth-sweep-control";
...
export default function DashboardPageClientV2() {
    ...
    >
      ...
      {!data ? null : (
        <>
          ...
          <div className="mt-6">
            <WealthSweepControl rule={data.sweep_rule} contributions={data.wealth_contributions} onChanged={refetch} />
          </div>
            ...
            <Card>
              ...
              <div className="mt-4 space-y-4">
                {data.empowerment_allocations.map((allocation) => (
                  <div key={allocation.id} className="surface-panel flex items-center justify-between gap-4 px-4 py-4">
                    <div>
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-[color:var(--text-strong)]">{formatCurrency(allocation.round_up_amount)}</p>
                      <p className="text-sm text-[color:var(--brand)]">Real sweep candidate from this spend</p>
