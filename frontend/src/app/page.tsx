export { default } from "./page-home-v2"; /*
...
const features = [
  ...
  { icon: ShieldCheck, title: "Fraud Intelligence", body: "Real-time anomaly detection backed by isolation models and notification workflows." },
          ...
          <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <div className="mt-12 grid gap-4 sm:grid-cols-3">
                {["₹1.8Cr assets modeled", "97.2% fraud detection confidence", "3.4x faster goal planning"].map((item) => (
            ...
            <Card className="relative overflow-hidden bg-gradient-to-b from-white/10 to-white/5">
              <p className="text-sm uppercase tracking-[0.3em] text-slate-400">Live AI insights</p>
              <div className="mt-8 space-y-4">
                {[
                  "Auto-invested ₹2,480 cashback into balanced momentum strategy.",
                  "Detected 3 subscription leaks worth ₹1,697 per month.",
                  "Travel goal can be reached 2 months earlier with weekend spend control.",
                ].map((line) => (
